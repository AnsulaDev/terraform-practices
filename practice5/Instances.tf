...
output "webPublicIP" {
    description = "AMI ID of Ubuntu instance"  # printing public ip of the ec2 instance
    value       = aws_instance.web.public_ip # Value to be output, referring to the ID of the fetched AMI
}


output "webPrivateIP" {
    description = "AMI ID of Ubuntu instance"  # printing public ip of the ec2 instance
    value       = aws_instance.web.private_ip # printing private ip of the ec2 instance
}
